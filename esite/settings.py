...
SECRET_KEY = '=yrx((=+#su!-n+x@2d(i5v1yzs0i+%um)@a^_*or6e8$*fw-g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #Specify Templates path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', #install(pip) psycopg - Adapter for postgresql
        'NAME': 'eapp',
        'USER': 'admin',
        'PASSWORD': 'password',
        'HOST': '127.0.0.1',
